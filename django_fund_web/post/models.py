...
class Post_bar_model(BaseModel):
    b_code = models.CharField("基金吧编号",max_length=20,unique=True,blank=True,
                    help_text="通常为基金编号，不可重复，默认不写自动生成。")
...
class Post_title_model(BaseModel):
    ...
    b_id = models.CharField('贴吧id',max_length=20,db_index=True)
